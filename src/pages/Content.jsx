...
import SectionSongs from "../section/SectionSongs";

//content
function Content() {
  return (
    <div>
      <div className="flex mt-24 gap-3">
      ...
      <div className="mt-12">
        <div>
          <Label label="START RADIO FROM A SONG" title="Quick picks" text="Play All"/>
          <SectionSongs
            data={[
              {
        ...
        <div className="mt-24">
          <Label label="FOR YOU" title="Trending community playlists" />
          <SectionPlaylist
            data={[
              {
        ...
        <div className="mt-24">
          <Label  title="Recommended playlists"  name="lalalala"/>
          <SectionPlaylist
